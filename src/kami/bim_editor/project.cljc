...
(defn document [{:keys [id name building-model family-catalog editor camera interaction]}]
...
(defn migrate [v]
  (cond
    ...
    (case (:kami/version v) 3 v
      2 (-> v (assoc :kami/version 3 :project/family-catalog {}))
      1 (-> v (assoc :kami/version 3 :project/interaction {:profile :revit}
                     :project/family-catalog {})
