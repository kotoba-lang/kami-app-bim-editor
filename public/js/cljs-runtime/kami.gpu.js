...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21717_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(caps,p1__21717_SHARP_) === true;
...
var runnable = cljs.core.filterv((function (p1__21778_SHARP_){
return kami.gpu.pass_runnable_QMARK_(caps,p1__21778_SHARP_);
}),new cljs.core.Keyword(null,"passes","passes",-2141861841).cljs$core$IFn$_invoke$arity$1(graph));
var skipped = cljs.core.vec((function (){var iter__5480__auto__ = (function kami$gpu$resolve_graph_$_iter__21780(s__21781){
...
var p = cljs.core._nth(c__5478__auto__,i__21782);
if((!(kami.gpu.pass_runnable_QMARK_(caps,p)))){
cljs.core.chunk_append(b__21783,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"pass","pass",1574159993),(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p);
...
var G__21819 = (i__21782 + (1));
i__21782 = G__21819;
continue;
} else {
var G__21820 = (i__21782 + (1));
i__21782 = G__21820;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21783),kami$gpu$resolve_graph_$_iter__21780(cljs.core.chunk_rest(s__21781__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21783),null);
}
} else {
var p = cljs.core.first(s__21781__$2);
if((!(kami.gpu.pass_runnable_QMARK_(caps,p)))){
...
})(),new cljs.core.Keyword(null,"missing","missing",362507769),kami.gpu.missing_caps(caps,p)], null),kami$gpu$resolve_graph_$_iter__21780(cljs.core.rest(s__21781__$2)));
} else {
var G__21824 = cljs.core.rest(s__21781__$2);
s__21781__$1 = G__21824;
continue;
}
}
} else {
...
/** @this {Function} */
(kami.gpu.requires.cljs$lang$applyTo = (function (seq21793){
var G__21794 = cljs.core.first(seq21793);
var seq21793__$1 = cljs.core.next(seq21793);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21794,seq21793__$1);
}));
