...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21625 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21625(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21626 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21626(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21629 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21629(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21633 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21633(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21636 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21636(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21639 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21639(reader);
}
});
...
var G__21799 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21800 = s.append(c);
c = G__21799;
s = G__21800;
continue;
}
