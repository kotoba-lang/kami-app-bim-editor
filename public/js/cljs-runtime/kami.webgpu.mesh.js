...
var n__5593__auto___22820 = (4);
var c_22821 = (0);
while(true){
if((c_22821 < n__5593__auto___22820)){
var n__5593__auto___22822__$1 = (4);
var r_22823 = (0);
while(true){
if((r_22823 < n__5593__auto___22822__$1)){
(o[((c_22821 * (4)) + r_22823)] = (((((a[r_22823]) * (b[((c_22821 * (4)) + (0))])) + ((a[(r_22823 + (4))]) * (b[((c_22821 * (4)) + (1))]))) + ((a[(r_22823 + (8))]) * (b[((c_22821 * (4)) + (2))]))) + ((a[(r_22823 + (12))]) * (b[((c_22821 * (4)) + (3))]))));

var G__22829 = (r_22823 + (1));
r_22823 = G__22829;
continue;
} else {
}
...
kami.webgpu.mesh.translation_matrix = (function kami$webgpu$mesh$translation_matrix(p__22465){
var vec__22466 = p__22465;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22466,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = (1));
...
kami.webgpu.mesh.scale_matrix = (function kami$webgpu$mesh$scale_matrix(p__22486){
var vec__22489 = p__22486;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22489,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22489,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22489,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = x);
 ...
 */
kami.webgpu.mesh.model_matrix = (function kami$webgpu$mesh$model_matrix(p__22534){
var map__22535 = p__22534;
var map__22535__$1 = cljs.core.__destructure_map(map__22535);
var translation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22535__$1,new cljs.core.Keyword(null,"translation","translation",-701621547),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var rotation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22535__$1,new cljs.core.Keyword(null,"rotation","rotation",-1728051644),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22535__$1,new cljs.core.Keyword(null,"scale","scale",-230427353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(1),(1)], null));
var vec__22541 = rotation;
var rx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22541,(0),null);
var ry = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22541,(1),null);
var rz = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22541,(2),null);
 ...
 */
kami.webgpu.mesh.upload_texture_BANG_ = (function kami$webgpu$mesh$upload_texture_BANG_(p__22564,p__22565){
var map__22566 = p__22564;
var map__22566__$1 = cljs.core.__destructure_map(map__22566);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22566__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22567 = p__22565;
var map__22567__$1 = cljs.core.__destructure_map(map__22567);
var bytes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22567__$1,new cljs.core.Keyword(null,"bytes","bytes",1175866680));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22567__$1,new cljs.core.Keyword(null,"mime-type","mime-type",1058646439));
 ...
 */
kami.webgpu.mesh.upload_mesh_BANG_ = (function kami$webgpu$mesh$upload_mesh_BANG_(p__22581,p__22582){
var map__22583 = p__22581;
var map__22583__$1 = cljs.core.__destructure_map(map__22583);
var context = map__22583__$1;
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22583__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22584 = p__22582;
var map__22584__$1 = cljs.core.__destructure_map(map__22584);
var geometry = map__22584__$1;
var positions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"positions","positions",-1380538434));
var normals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"normals","normals",-1508109067));
var indices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"indices","indices",-1218138343));
var uvs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"uvs","uvs",1776835110));
var morph_target_deltas = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"morph-target-deltas","morph-target-deltas",-1534652085));
var joints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"joints","joints",-1993525003));
var weights = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22584__$1,new cljs.core.Keyword(null,"weights","weights",-1097626197));
...
var n__5593__auto___22862 = vcount;
var i_22863 = (0);
while(true){
if((i_22863 < n__5593__auto___22862)){
var base_22864 = (i_22863 * (16));
var p_22865 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(positions,i_22863);
var n_22866 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(normals,i_22863);
var uv_22867 = ((has_uv_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(uvs,i_22863):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0], null));
var j_22868 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(joints,i_22863):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(0)], null));
var w_22869 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(weights,i_22863):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [1.0,0.0,0.0,0.0], null));
interleaved.set(kami.webgpu.mesh.f32(p_22865),base_22864);

interleaved.set(kami.webgpu.mesh.f32(n_22866),(base_22864 + (3)));

interleaved.set(kami.webgpu.mesh.f32(uv_22867),(base_22864 + (6)));

joints_view.set((new Uint32Array(cljs.core.clj__GT_js(cljs.core.vec(j_22868)))),(base_22864 + (8)));

interleaved.set(kami.webgpu.mesh.f32(w_22869),(base_22864 + (12)));

var G__22881 = (i_22863 + (1));
i_22863 = G__22881;
continue;
} else {
}
...
(kami.webgpu.mesh.draw_BANG_.cljs$core$IFn$_invoke$arity$8 = (function (p__22656,pass,p__22657,mvp,color,morph_weights,joint_matrices,p__22658){
var map__22659 = p__22656;
var map__22659__$1 = cljs.core.__destructure_map(map__22659);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22659__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var pipe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22659__$1,new cljs.core.Keyword(null,"pipe","pipe",336575849));
var default_texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22659__$1,new cljs.core.Keyword(null,"default-texture","default-texture",1829125666));
var default_sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22659__$1,new cljs.core.Keyword(null,"default-sampler","default-sampler",1041755191));
var map__22660 = p__22657;
var map__22660__$1 = cljs.core.__destructure_map(map__22660);
var idx_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"idx-count","idx-count",-1289353607));
var vbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"vbuf","vbuf",303950747));
var morph_deltas_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"morph-deltas-buf","morph-deltas-buf",-129639776));
var ibuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"ibuf","ibuf",801056512));
var joint_matrices_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"joint-matrices-buf","joint-matrices-buf",-625207643));
var vertex_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"vertex-count","vertex-count",1997450535));
var morph_weights_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"morph-weights-buf","morph-weights-buf",-451235347));
var gbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"gbuf","gbuf",897732527));
var morph_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"morph-count","morph-count",-176849136));
var joint_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22660__$1,new cljs.core.Keyword(null,"joint-count","joint-count",663399985));
var map__22662 = p__22658;
var map__22662__$1 = cljs.core.__destructure_map(map__22662);
var color_b = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"color-b","color-b",-988878341),color);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"kind","kind",-717265803),(0));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0,0.0,0.0], null));
var texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22662__$1,new cljs.core.Keyword(null,"texture","texture",-266291651));
var sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22662__$1,new cljs.core.Keyword(null,"sampler","sampler",2068889864));
var shade_kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"shade-kind","shade-kind",-1825128023),(0));
var toon_threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"toon-threshold","toon-threshold",-2084408130),0.4);
var toon_smooth = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22662__$1,new cljs.core.Keyword(null,"toon-smooth","toon-smooth",-1986013699),0.08);
...
var gview_23016 = (new Uint32Array(gdata.buffer));
(gview_23016[(24)] = vertex_count);

(gview_23016[(25)] = morph_count);

(gview_23016[(26)] = joint_count);

(gview_23016[(27)] = kind);

(gview_23016[(32)] = shade_kind);
...
var map__22741 = viewport;
var map__22741__$1 = cljs.core.__destructure_map(map__22741);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var queue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"queue","queue",1455835879));
var ctx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"ctx","ctx",-493610118));
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var mesh_context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"mesh-context","mesh-context",832369712));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22741__$1,new cljs.core.Keyword(null,"height","height",1025178622));
