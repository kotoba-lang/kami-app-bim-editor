...
var vec__21924 = t;
var head = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21924,(0),null);
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21924,(1),null);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(base),"<",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__21928 = (function (){var or__5002__auto__ = elem;
...
return (kami.wgsl.type_str.cljs$core$IFn$_invoke$arity$1 ? kami.wgsl.type_str.cljs$core$IFn$_invoke$arity$1(G__21928) : kami.wgsl.type_str.call(null, G__21928));
})()),">"].join('');
} else {
...
break;
case ".":
return ["(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__21939 = cljs.core.first(xs);
return (go.cljs$core$IFn$_invoke$arity$1 ? go.cljs$core$IFn$_invoke$arity$1(G__21939) : go.call(null, G__21939));
...
var G__21940 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"ident","ident",-742346),kami.wgsl.ident,new cljs.core.Keyword(null,"num","num",1985240673),kami.wgsl.num,new cljs.core.Keyword(null,"call","call",-519999866),kami.wgsl.wgsl_call,new cljs.core.Keyword(null,"special","special",-1125941630),kami.wgsl.wgsl_special], null);
var G__21941 = e;
return (kotoba.expr.compile.cljs$core$IFn$_invoke$arity$2 ? kotoba.expr.compile.cljs$core$IFn$_invoke$arity$2(G__21940,G__21941) : kotoba.expr.compile.call(null, G__21940,G__21941));
});
kami.wgsl.block = (function kami$wgsl$block(stmts){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21946_SHARP_){
return ["  ",clojure.string.replace((kami.wgsl.stmt.cljs$core$IFn$_invoke$arity$1 ? kami.wgsl.stmt.cljs$core$IFn$_invoke$arity$1(p1__21946_SHARP_) : kami.wgsl.stmt.call(null, p1__21946_SHARP_)),"\n","\n  ")].join('');
}),stmts));
});
kami.wgsl.for_step = (function kami$wgsl$for_step(s){
var vec__21949 = s;
var op = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21949,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21949,(1),null);
var G__21952 = op;
...
var vec__21960 = s;
var seq__21961 = cljs.core.seq(vec__21960);
var first__21962 = cljs.core.first(seq__21961);
var seq__21961__$1 = cljs.core.next(seq__21961);
var op = first__21962;
var xs = seq__21961__$1;
var G__21963 = op;
...
case "for":
var vec__21970 = xs;
var seq__21971 = cljs.core.seq(vec__21970);
var first__21972 = cljs.core.first(seq__21971);
var seq__21971__$1 = cljs.core.next(seq__21971);
var init = first__21972;
var first__21972__$1 = cljs.core.first(seq__21971__$1);
var seq__21971__$2 = cljs.core.next(seq__21971__$1);
var cnd = first__21972__$1;
var first__21972__$2 = cljs.core.first(seq__21971__$2);
var seq__21971__$3 = cljs.core.next(seq__21971__$2);
var step = first__21972__$2;
var body = seq__21971__$3;
...
kami.wgsl.param_str = (function kami$wgsl$param_str(p__21990){
var vec__21991 = p__21990;
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21991,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21991,(1),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21991,(2),null);
...
var len__5726__auto___22048 = arguments.length;
var i__5727__auto___22049 = (0);
while(true){
if((i__5727__auto___22049 < len__5726__auto___22048)){
args__5732__auto__.push((arguments[i__5727__auto___22049]));

var G__22056 = (i__5727__auto___22049 + (1));
i__5727__auto___22049 = G__22056;
continue;
} else {
}
break;
...
(kami.wgsl.func.cljs$core$IFn$_invoke$arity$variadic = (function (name,p__22007,body){
var map__22008 = p__22007;
var map__22008__$1 = cljs.core.__destructure_map(map__22008);
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22008__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var workgroup_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22008__$1,new cljs.core.Keyword(null,"workgroup-size","workgroup-size",-1458663590));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22008__$1,new cljs.core.Keyword(null,"params","params",710516235));
var ret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22008__$1,new cljs.core.Keyword(null,"ret","ret",-468222814));
...
/** @this {Function} */
(kami.wgsl.func.cljs$lang$applyTo = (function (seq22003){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22004,G__22005,seq22003__$2);
}));
 ...
 */
kami.wgsl.binding_STAR_ = (function kami$wgsl$binding_STAR_(p__22015,name,type){
var map__22017 = p__22015;
var map__22017__$1 = cljs.core.__destructure_map(map__22017);
var group = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"group","group",582596132));
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
var space = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"space","space",348133475));
var access = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"access","access",2027349272));
...
var args__5732__auto__ = [];
var len__5726__auto___22064 = arguments.length;
var i__5727__auto___22065 = (0);
while(true){
if((i__5727__auto___22065 < len__5726__auto___22064)){
args__5732__auto__.push((arguments[i__5727__auto___22065]));

var G__22067 = (i__5727__auto___22065 + (1));
i__5727__auto___22065 = G__22067;
continue;
} else {
}
break;
...
/** @this {Function} */
(kami.wgsl.shader.cljs$lang$applyTo = (function (seq22026){
